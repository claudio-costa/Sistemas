...
namespace MobLink.WebLeilao.Dominio
{
    public class Proprietario____
    {
        ...
        public virtual string Data_Hora_Apreensao { get; set; }
        public virtual string Processo { get; set; }

        public virtual int id_cliente { get; set; }

        public virtual bool Proprietario_Conferido { get; set; }
        public virtual bool Comunicado_Conferido { get; set; }
        public virtual bool Financeira_Conferido { get; set; }
